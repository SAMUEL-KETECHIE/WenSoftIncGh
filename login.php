	...
	<center>
		<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" autocomplete="off">
			...
			<div class="form-group">
				...
				<input name="password" id="password" type="password" class="form-control" autocomplete="off" placeholder="ENTER PASSWORD" required></input>
				<br>
				<span style="color:red"><?php if(isset($passwordError)) echo $passwordError;?></span>
			</div>
				<hr>
			<div class="form-group">
				<center><button class="btn-danger form-control" type="submit" name="btn-login">LOGIN</button></center>
			</div>
		</form>
	</center>
	<h5 style="color: white; background: black;">If you haven't signed up wet, please register here!!! <a href="register.php" style="text-decoration: none">Sign up</a></h5>
